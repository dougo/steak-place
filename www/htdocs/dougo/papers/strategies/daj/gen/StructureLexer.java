// $ANTLR : "Structure.g" -> "StructureLexer.java"$
...
public class StructureLexer extends antlr.CharScanner implements StructureParserTokenTypes, TokenStream
 {
public StructureLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public StructureLexer(Reader in) {
	this(new CharBuffer(in));
}
public StructureLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public StructureLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("a", this), new Integer(4));
	literals.put(new ANTLRHashString("d", this), new Integer(6));
	literals.put(new ANTLRHashString("true", this), new Integer(8));
	literals.put(new ANTLRHashString("b", this), new Integer(5));
	literals.put(new ANTLRHashString("e", this), new Integer(7));
