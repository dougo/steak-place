...
(let ((instance-type (make-record-type 'instance '(class fields))))
  ...
  (case (scheme-implementation-type)
    ...
    ((larceny)
     ((record-updater *rtd-type* 'printer) instance-type prt-obj))
    ((chez) ???)
    (else ???))
...
(define-syntax define-method
  (syntax-rules ()
    ((define-method (gf parmspec ...) body ...)
     (define-method "normalize" gf () () (parmspec ...) body ...))
    ((define-method "normalize" gf (p0 ...) (s0 ...) ((pi si) ps ...) b ...)
     (define-method "normalize" gf (p0 ... pi) (s0 ... si) (ps ...) b ...))
    ((define-method "normalize" gf (p0 ...) (s0 ...) (pi ps ...) b ...)
     (define-method "normalize" gf (p0 ... pi) (s0 ... <top>) (ps ...) b ...))
    ((define-method "normalize" gf (parm ...) (spec ...) () body ...)
     (begin
       (add-method! gf
